...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles =
      "inline-flex items-center justify-center text-center font-bold rounded-lg max-w-full transition-all duration-200 focus:outline-none focus:ring-4 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed";
    ...
    const sizes = {
      ...
      lg: "px-6 py-4 text-lg md:px-8 md:text-xl",
    };
