          ...
          <div className="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6">
            ...
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div><h3 className="font-bold text-navy mb-2">Quiz Results</h3><div className="space-y-1"><p><strong>Type:</strong> {Array.isArray(selectedLead.quiz_responses.shirtType) ? selectedLead.quiz_responses.shirtType.join(", ") : selectedLead.quiz_responses.shirtType}</p><p><strong>Decades:</strong> {selectedLead.quiz_responses.decades.join(", ")}</p><p><strong>Condition:</strong> {selectedLead.quiz_responses.condition ?? "—"}</p></div></div>
              </div>
